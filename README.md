...
- Use the `Ctx` forms — [`iter.MapCtx`](https://pkg.go.dev/github.com/purpleclay/conker/iter#MapCtx), [`iter.MapSeqCtx`](https://pkg.go.dev/github.com/purpleclay/conker/iter#MapSeqCtx), [`iter.ForEachCtx`](https://pkg.go.dev/github.com/purpleclay/conker/iter#ForEachCtx), and friends — if in-flight work must observe cancellation; breaking out of a lazy range cancels it too.
